...
describe('Format Executor', () => {
  ...
  it('should run format command with basic options', async () => {
    const output = await executor(options, context);

    expect(execSync).toHaveBeenCalledWith(
      'npx biome format "/root/project/src/**/*.ts"',
      expect.any(Object)
    );
  ...
  it('should add write flag when write option is true', async () => {
    ...
    expect(execSync).toHaveBeenCalledWith(
      'npx biome format "/root/project/src/**/*.ts" --write',
      expect.any(Object)
    );
  });
  ...
  it('should add unsafe flag when unsafe option is true', async () => {
    ...
    expect(execSync).toHaveBeenCalledWith(
      'npx biome format "/root/project/src/**/*.ts" --unsafe',
      expect.any(Object)
    );
  });
  ...
  it('should handle multiple file patterns', async () => {
    ...
    expect(execSync).toHaveBeenCalledWith(
      'npx biome format "/root/project/src/**/*.ts" "/root/project/test/**/*.ts"',
      expect.any(Object)
    );
  });
